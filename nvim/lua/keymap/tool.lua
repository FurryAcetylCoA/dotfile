...
local plug_map = {
	...
	["n|<leader>ll"] = map_cr("Trouble lsp_references")
		:with_noremap()
		:with_silent()
		:with_desc("lsp: Show lsp references"),
	["n|<leader>ld"] = map_cr("Trouble lsp_definitions toggle")
		:with_noremap()
		:with_silent()
		:with_desc("lsp: Show document diagnostics"),
	["n|<leader>lw"] = map_cr("Trouble lsp_document_symbols toggle")
		:with_noremap()
		:with_silent()
		:with_desc("lsp: Show workspace diagnostics"),
	["n|<leader>lq"] = map_cr("Trouble quickfix toggle")
		:with_noremap()
		:with_silent()
		:with_desc("lsp: Show quickfix list"),
	["n|<leader>lL"] = map_cr("Trouble loclist loclist"):with_noremap():with_silent():with_desc("lsp: Show loclist"),
